...
public class StatisticsConverter {
    ...
    public static StatisticsResponseDto.GetStatisticsDto toGetStatisticsDto(final Statistics statistics, final Answer answer) {
        return StatisticsResponseDto.GetStatisticsDto.builder()
                .day(answer.getCreatedAt().atZone(ZoneId.of(BASE_TIME_ZONE))
